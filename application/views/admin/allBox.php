<div class="container">
    ...
    <div class="well well-sm">
        <div class="row">
            <div class="pull-right">
                <a href="<?=base_url()?>admin/MainSections/addBox">
    ...
    <table class="table table-hover table-bordered table-striped">
        ...
        foreach($sportpits as $row)
        {
            echo '<tr>';
            echo '<td>'.$i++.'</td>';
            echo '<td><img class="photo_user" src="'.site_url().'public/images/main/'.$row->img_name.'" alt="">'.'</td>';
            ...
            echo '<td><a href="'.site_url().'admin/MainSections/deleteBox/'.$row->id.'"><button type="button" class="btn btn-danger">Удалить</button></a></td>';
            echo '</tr>';
        }
        ?>
    </table>
